...
//#region node_modules/.nitro/vite/services/ssr/assets/auth-middleware-Oflpx3X0.js
var requireSupabaseAuth = createMiddleware({ type: "function" }).server(async ({ next }) => {
	...
	if (!SUPABASE_URL || SUPABASE_URL.includes("xgconhzyasyyzvzpjahx")) {
		...
		const { initMockCredits, createMockSupabaseClient } = await import("./mock-client-DsyBJBK7.mjs").then((n) => n.i).then((n) => n.r);
